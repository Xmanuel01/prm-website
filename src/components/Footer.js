    ...
    <footer className="bg-gray-900 text-white pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          <div className="lg:col-span-2">
            <div className="flex items-center mb-4">
              ...
              />
              <span className="text-xl font-serif font-bold">People's Reform Movement</span>
            </div>
            <p className="mb-4 text-gray-300">
              Committed to transparent governance, economic empowerment, and social justice for all citizens.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} People's Reform Movement. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
